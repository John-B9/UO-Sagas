----------------------------------------------------------------------
-- Item Properties Lib v0.1.0
-- Lib created by: JohnB9
----------------------------------------------------------------------
...
local function getItemDoubleValueProperty_(item, doubleValuePropertyRegexStr)
    ...
    if lPropertyVal == nil or rPropertyVal == nil then
        printIfDebug_(debugEnabled, "Double Value Property = (nil)")
        return nil
    end
    printIfDebug_(debugEnabled, "Double Value Property = (" .. lPropertyVal .. "," .. rPropertyVal .. ")")
