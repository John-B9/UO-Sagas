...
local DexerMainLoopConfig = {
    ...
    modules = {
        ...
        CurePotions = {
            Enable = true, --- Cures poison with potions first (can be a waste of potions)
        ...
        Buffs = {
            ...
            EatFood = {
                Enable = true --- BUGGED: Buff foods don't prevent eating if already under the effect
            }
        },
        Debuffs = {
...
local Obj = {
    ...
    mainLoopConfig = DexerMainLoopConfig
}
